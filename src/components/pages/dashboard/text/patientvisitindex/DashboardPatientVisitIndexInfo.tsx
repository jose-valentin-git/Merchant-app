...
const DashboardPatientVisitIndexInfo: FC = () => {
  return (
    <>
      <div className="continer-fluid text-purple m-3 position-relative bg-palepurple">
        <div className="row  p-4 rounded d-flex align-items-center justify-content-center">
          <div className="col">
            <p className="fs-5 fw-bolder">
              Use Mobile No Of patients to view this report
            </p>
          </div>
        </div>
        <svg
...
export default DashboardPatientVisitIndexInfo;
