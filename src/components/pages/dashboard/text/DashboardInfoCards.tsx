...
const DashboardInfoCards: FC<DashboardInfoCardsProps> = ({ text }) => {
  return (
    <>
      <div className="continer-fluid text-purple m-3 rounded position-relative bg-palepurple overflow-hidden">
        <div className="row p-4 rounded d-flex align-items-center justify-content-start ">
          <div className="col-10">
            <p className="fs-5 fw-bolder z-1">{text} </p>
          </div>
        </div>
        <svg
          width={300}
